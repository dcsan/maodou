ChatlogsComponent = React.createClass({
  ...
  sendChat(event) {
    ...
    // var content = "news for " + this.data.player.nickname;

    // Meteor.call("wc/news", this.data.player.openid, text);
    Meteor.call("wc/text", this.data.player.openid, text);
    // Clear form
  ...
  render() {
    ...
    return <div>
      ...
      <p>player.openid: {this.data.player.openid}</p>
      <h2>Chatlog</h2>
      <ul>
        {this.chatLog()}
      </ul>
